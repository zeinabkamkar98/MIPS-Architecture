...
//a generic adder
public class NextPcValueBit extends Wrapper {
    public NextPcValueBit(String label, String stream, Link... links) {
    ...
    public void initialize() {
        ...
        //cal jumpAddress
        ShiftLeft26to31 shift28=new ShiftLeft26to31("shift31","26x31");
        shift28.addInput(
        ...
        jumpAdd.addInput(
                ...
                shift28.getOutput(24),shift28.getOutput(25),shift28.getOutput(26),shift28.getOutput(27),shift28.getOutput(28),shift28.getOutput(29),shift28.getOutput(30)
        );
