...
public class Sample {
    ...
    public static void main(String[] args) {
        ...
        registerfile.addInput(
                ...
                muxsbeforereg.get(0).getOutput(0),muxsbeforereg.get(1).getOutput(0),muxsbeforereg.get(2).getOutput(0),muxsbeforereg.get(3).getOutput(0),
                muxsbeforereg.get(4).getOutput(0),
